...
@section('content')
            ...
            <div class="card-body card-padding">
                ...
                <div class="dropdown-btn-demo">
                    <div class="dropdown" data-animation="fadeIn,fadeOut,600">
                        <button type="button" class="btn btn-primary waves-effect waves-button waves-float" data-toggle="dropdown">Fade In <i class="caret"></i></button>
                    ...
                    <div class="dropdown" data-animation="fadeInUp,fadeOutDown,600">
                        <button type="button" class="btn btn-primary waves-effect waves-button waves-float" data-toggle="dropdown">Fade In Up <i class="caret"></i></button>
                    ...
                    <div class="dropdown" data-animation="fadeInLeft,fadeOutLeft,600">
                        <button type="button" class="btn btn-primary waves-effect waves-button waves-float" data-toggle="dropdown">Fade In Left <i class="caret"></i></button>
                    ...
                    <div class="dropdown" data-animation="fadeInRight,fadeOutRight,600">
                        <button type="button" class="btn btn-primary waves-effect waves-button waves-float" data-toggle="dropdown">Fade In Right <i class="caret"></i></button>
                    ...
                    <div class="dropdown" data-animation="bounceIn,bounceOut,1000">
                        <button type="button" class="btn btn-primary waves-effect waves-button waves-float" data-toggle="dropdown">Bounce In <i class="caret"></i></button>
                    ...
                    <div class="dropdown" data-animation="fadeInDown,fadeOutUp,600">
                        <button type="button" class="btn btn-primary waves-effect waves-button waves-float" data-toggle="dropdown">Fade In Down <i class="caret"></i></button>
                    ...
                    <div class="dropdown" data-animation="flipInX,flipOutX">
                        <button type="button" class="btn btn-primary waves-effect waves-button waves-float" data-toggle="dropdown">Flip In X <i class="caret"></i></button>
                    ...
                    <div class="dropdown" data-animation="flipInY,flipOutY">
                        <button type="button" class="btn btn-primary waves-effect waves-button waves-float" data-toggle="dropdown">Flip In Y <i class="caret"></i></button>
                    ...
                    <div class="dropdown" data-animation="rollIn,rollOut,600">
                        <button type="button" class="btn btn-primary waves-effect waves-button waves-float" data-toggle="dropdown">Roll In <i class="caret"></i></button>
                    ...
                    <div class="dropdown" data-animation="rotateIn,rotateOut,600">
                        <button type="button" class="btn btn-primary waves-effect waves-button waves-float" data-toggle="dropdown">Rotate In <i class="caret"></i></button>
                    ...
                    <div class="dropdown" data-animation="lightSpeedIn,lightSpeedOut,1000">
                        <button type="button" class="btn btn-primary waves-effect waves-button waves-float" data-toggle="dropdown">Light Speed In <i class="caret"></i></button>
                ...
                <div class="clearfix dropdown-btn-demo">
                    <div class="dropdown">
                        <button type="button" class="btn btn-default waves-effect waves-button waves-float" data-toggle="dropdown" aria-expanded="false">Dropdown Left</button>
                    ...
                    <div class="dropdown">
                        <button type="button" class="btn btn-default waves-effect waves-button waves-float" data-toggle="dropdown" aria-expanded="false">Dropdown Right</button>
                ...
                <div class="dropdown-btn-demo">
                    <div class="dropdown dropup">
                        <a href="#" class="dropdown-toggle btn btn-default waves-effect waves-button waves-float" data-toggle="dropdown">This is a Dropup</a>
                        <ul class="dropdown-menu">
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Action</a></li>
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Another action</a></li>
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Something else here</a></li>
                    ...
                    <div class="dropdown dropup">
                        <a href="#" class="dropdown-toggle btn btn-default waves-effect waves-button waves-float" data-toggle="dropdown">This is another Dropup</a>
                        <ul class="dropdown-menu">
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Action</a></li>
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Another action</a></li>
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Something else here</a></li>
                    ...
                    <div class="dropdown dropup">
                        <a href="#" class="dropdown-toggle btn btn-default waves-effect waves-button waves-float" data-toggle="dropdown">This is right aligned Dropup</a>
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Action</a></li>
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Another action</a></li>
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Something else here</a></li>
                ...
                <div class="dropdown-btn-demo">
                    <div class="dropdown">
                        <a href="#" class="dropdown-toggle btn btn-default waves-effect waves-button waves-float" data-toggle="dropdown">Default</a>
                    ...
                    <div class="dropdown">
                        <a href="#" class="dropdown-toggle btn btn-primary waves-effect waves-button waves-float" data-toggle="dropdown">Primary</a>
                        <ul class="dropdown-menu pull-left">
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Action</a></li>
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Another action</a></li>
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Something else here</a></li>
                    ...
                    <div class="dropdown">
                        <a href="#" class="dropdown-toggle btn btn-info waves-effect waves-button waves-float" data-toggle="dropdown">Info</a>
                        <ul class="dropdown-menu">
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Action</a></li>
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Another action</a></li>
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Something else here</a></li>
                    ...
                    <div class="dropdown">
                        <a href="#" class="dropdown-toggle btn btn-success waves-effect waves-button waves-float" data-toggle="dropdown">Success</a>
                        <ul class="dropdown-menu">
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Action</a></li>
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Another action</a></li>
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Something else here</a></li>
                    ...
                    <div class="dropdown">
                        <a href="#" class="dropdown-toggle btn btn-warning waves-effect waves-button waves-float" data-toggle="dropdown">Warning</a>
                        <ul class="dropdown-menu">
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Action</a></li>
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Another action</a></li>
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Something else here</a></li>
                    ...
                    <div class="dropdown">
                        <a href="#" class="dropdown-toggle btn btn-danger waves-effect waves-button waves-float" data-toggle="dropdown">Danger</a>
                        <ul class="dropdown-menu">
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Action</a></li>
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Another action</a></li>
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Something else here</a></li>
                    ...
                    <div class="dropdown">
                        <a href="#" class="dropdown-toggle btn btn-link waves-effect waves-button waves-float" data-toggle="dropdown">Link</a>
                        <ul class="dropdown-menu">
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Action</a></li>
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Another action</a></li>
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Something else here</a></li>
                ...
                <div class="dropdown-btn-demo">
                    <div class="btn-group">
                        <button type="button" class="btn btn-default waves-effect waves-button waves-float">Default</button>
                        <button type="button" class="btn btn-default dropdown-toggle waves-effect waves-button waves-float" data-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="btn-group">
                        <button type="button" class="btn btn-primary waves-effect waves-button waves-float">Primary</button>
                        <button type="button" class="btn btn-primary dropdown-toggle waves-effect waves-button waves-float" data-toggle="dropdown" aria-expanded="false">
                            <span class="caret"></span>
                            <span class="sr-only">Split button dropdowns</span>
                        </button>
                        <ul class="dropdown-menu" role="menu">
                    ...
                    <div class="btn-group">
                        <button type="button" class="btn btn-info waves-effect waves-button waves-float">Info</button>
                    ...
                    <div class="btn-group">
                        <button type="button" class="btn btn-success waves-effect waves-button waves-float">Success</button>
                        <button type="button" class="btn btn-success dropdown-toggle waves-effect waves-button waves-float" data-toggle="dropdown" aria-expanded="false">
                            <span class="caret"></span>
                            <span class="sr-only">Split button dropdowns</span>
                        </button>
                        <ul class="dropdown-menu" role="menu">
                    ...
                    <div class="btn-group">
                        <button type="button" class="btn btn-warning waves-effect waves-button waves-float">Warning</button>
                        <button type="button" class="btn btn-warning dropdown-toggle waves-effect waves-button waves-float" data-toggle="dropdown" aria-expanded="false">
                            <span class="caret"></span>
                            <span class="sr-only">Split button dropdowns</span>
                        </button>
                        <ul class="dropdown-menu" role="menu">
                    ...
                    <div class="btn-group">
                        <button type="button" class="btn btn-danger waves-effect waves-button waves-float">Danger</button>
                        <button type="button" class="btn btn-danger dropdown-toggle waves-effect waves-button waves-float" data-toggle="dropdown" aria-expanded="false">
                            <span class="caret"></span>
                            <span class="sr-only">Split button dropdowns</span>
                        </button>
                        <ul class="dropdown-menu" role="menu">
        ...
        <div class="card">
            ...
            <div class="card-body card-padding">
                ...
                <div class="btn-demo">
                    <a data-toggle="modal" href="#modalDefault" class="btn btn-sm btn-default waves-effect waves-button waves-float">Modal - Default</a>
                    <a data-toggle="modal" href="#modalNarrower" class="btn btn-sm btn-default waves-effect waves-button waves-float">Modal - Small</a>
                    <a data-toggle="modal" href="#modalWider" class="btn btn-sm btn-default waves-effect waves-button waves-float">Modal - Large</a>
                </div>
                ...
                <div class="btn-demo">
                    <a data-toggle="modal" href="#noAnimation" class="btn btn-default waves-effect waves-button waves-float">Without Animation</a>
                    <a data-toggle="modal" href="#preventClick" class="btn btn-default waves-effect waves-button waves-float">Prevent Outside Click</a>
                </div>

                <div class="modal" id="noAnimation" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">Modal title</h4>
                ...
                <div class="btn-demo" id="btn-color-targets">
                    <a href="#modalColor" data-target-color="blue" data-toggle="modal" class="btn bgm-blue waves-effect waves-button waves-float">Blue</a>
                    <a href="#modalColor" data-target-color="lightblue" data-toggle="modal" class="btn bgm-lightblue waves-effect waves-button waves-float">Light Blue</a>
                    <a href="#modalColor" data-target-color="cyan" data-toggle="modal" class="btn bgm-cyan waves-effect waves-button waves-float">Cyan</a>
                    <a href="#modalColor" data-target-color="green" data-toggle="modal" class="btn bgm-green waves-effect waves-button waves-float">Green</a>
                    <a href="#modalColor" data-target-color="lightgreen" data-toggle="modal" class="btn bgm-lightgreen waves-effect waves-button waves-float">Light Green</a>
                    <a href="#modalColor" data-target-color="red" data-toggle="modal" class="btn bgm-red waves-effect waves-button waves-float">Red</a>
                    <a href="#modalColor" data-target-color="amber" data-toggle="modal" class="btn bgm-amber waves-effect waves-button waves-float">Amber</a>
                    <a href="#modalColor" data-target-color="orange" data-toggle="modal" class="btn bgm-orange waves-effect waves-button waves-float">Orange</a>
                    <a href="#modalColor" data-target-color="teal" data-toggle="modal" class="btn bgm-teal waves-effect waves-button waves-float">Teal</a>
                    <a href="#modalColor" data-target-color="bluegray" data-toggle="modal" class="btn bgm-bluegray waves-effect waves-button waves-float">Blue Gray</a>
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body card-padding">
                ...
                <div role="tabpanel">
                    <ul class="tab-nav tab-nav-right" role="tablist" tabindex="2" style="overflow: hidden; outline: none;">
                ...
                <div class="row margin-bottom">
                    <div role="tabpanel" class="col-sm-6">
                        <ul class="tab-nav" role="tablist" data-tab-color="red" tabindex="5" style="overflow: hidden; outline: none;">
                    ...
                    <div role="tabpanel" class="col-sm-6">
                        <ul class="tab-nav" role="tablist" data-tab-color="green" tabindex="6" style="overflow: hidden; outline: none;">
                    ...
                    <div role="tabpanel" class="col-sm-6">
                        <ul class="tab-nav" role="tablist" data-tab-color="teal" tabindex="7" style="overflow: hidden; outline: none;">
                    ...
                    <div role="tabpanel" class="col-sm-6">
                        <ul class="tab-nav" role="tablist" data-tab-color="amber" tabindex="8" style="overflow: hidden; outline: none;">
                    ...
                    <div role="tabpanel" class="col-sm-6">
                        <ul class="tab-nav" role="tablist" data-tab-color="black" tabindex="9" style="overflow: hidden; outline: none;">
                    ...
                    <div role="tabpanel" class="col-sm-6">
                        <ul class="tab-nav" role="tablist" data-tab-color="cyan" tabindex="10" style="overflow: hidden; outline: none;">
                ...
                <div class="form-wizard-basic fw-container">
                    ...
                    <div class="tab-content">
                        ...
                        <ul class="fw-footer pagination wizard">
                            <li class="previous first disabled"><a class="a-prevent" href=""><i class="md md-more-horiz"></i></a></li>
                            <li class="previous disabled"><a class="a-prevent" href=""><i class="md md-chevron-left"></i></a></li>
        ...
        <div class="card">
            ...
            <div class="card-body card-padding">
                ...
                <div class="btn-demo">
                    <a class="btn btn-primary waves-effect waves-button waves-float" data-toggle="collapse" href="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                        Link with href
                    </a>
                    <button class="btn btn-primary waves-effect waves-button waves-float" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
        ...
        <div class="card">
            ...
            <div class="card-body card-padding">
                ...
                <div class="btn-demo">
                    <button type="button" class="btn btn-primary waves-effect waves-button waves-float" data-toggle="tooltip" data-placement="left" title="" data-original-title="Tooltip on left">Tooltip on left</button>
                    <button type="button" class="btn btn-primary waves-effect waves-button waves-float" data-toggle="tooltip" data-placement="top" title="" data-original-title="Tooltip on top">Tooltip on top</button>
                    <button type="button" class="btn btn-primary waves-effect waves-button waves-float" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Tooltip on bottom">Tooltip on bottom</button>
                    <button type="button" class="btn btn-primary waves-effect waves-button waves-float" data-toggle="tooltip" data-placement="right" title="" data-original-title="Tooltip on right">Tooltip on right</button>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body card-padding">
                ...
                <div class="btn-demo">
                    <!-- Top -->
                    <button class="btn btn-primary waves-effect waves-button waves-float" data-toggle="popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." title="" data-original-title="Popover Title">
                        Top
                    </button>

                    <!-- Right -->
                    <button class="btn btn-primary waves-effect waves-button waves-float" data-toggle="popover" data-placement="right" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." title="" data-original-title="Popover Title">
                        Right
                    </button>

                    <!-- Bottom -->
                    <button class="btn btn-primary waves-effect waves-button waves-float" data-toggle="popover" data-placement="bottom" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." title="" data-original-title="Popover Title">
                        Bottom
                    </button>

                    <!-- Left -->
                    <button class="btn btn-primary waves-effect waves-button waves-float" data-toggle="popover" data-placement="left" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." title="" data-original-title="Popover Title">
                        Left
                    </button>
                </div>
                ...
                <div class="btn-demo">
                    <!-- Top -->
                    <button class="btn btn-primary waves-effect waves-button waves-float" data-trigger="hover" data-toggle="popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." title="" data-original-title="Popover Title">
                        Top
                    </button>

                    <!-- Right -->
                    <button class="btn btn-primary waves-effect waves-button waves-float" data-trigger="hover" data-toggle="popover" data-placement="right" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." title="" data-original-title="Popover Title">
                        Right
                    </button>

                    <!-- Bottom -->
                    <button class="btn btn-primary waves-effect waves-button waves-float" data-trigger="hover" data-toggle="popover" data-placement="bottom" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." title="" data-original-title="Popover Title">
                        Bottom
                    </button>

                    <!-- Left -->
                    <button class="btn btn-primary waves-effect waves-button waves-float" data-trigger="hover" data-toggle="popover" data-placement="left" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." title="" data-original-title="Popover Title">
                        Left
                    </button>
                </div>
            </div>
